...
func (r MachineIOPS) Validate() error {
	if r == 0 {
		return contractError(errors.New("standard machine IOPS is zero"))
	}
	return nil
}
...
func (r MachineBytesPerSecond) Validate() error {
	if r == 0 {
		return contractError(errors.New("standard machine byte rate is zero"))
	}
	return nil
}
...
func (r MachineBitsPerSecond) Validate() error {
	if r == 0 {
		return contractError(errors.New("standard machine bit rate is zero"))
	}
	return nil
}
...
func (k *MachineToolchainKind) UnmarshalJSON(data []byte) error {
	if k == nil {
		return jsonError(errors.New("nil standard machine toolchain kind receiver"))
	}
...
func (m *MachineInstallMode) UnmarshalJSON(data []byte) error {
	if m == nil {
		return jsonError(errors.New("nil standard machine install mode receiver"))
	}
...
func (m *MachineProvisioningModel) UnmarshalJSON(data []byte) error {
	if m == nil {
		return jsonError(errors.New("nil standard machine provisioning model receiver"))
	}
...
func (m *MachineMaintenancePolicy) UnmarshalJSON(data []byte) error {
	if m == nil {
		return jsonError(errors.New("nil standard machine maintenance policy receiver"))
	}
...
func (f MachineFingerprint) Validate() error {
	if f.SchemaVersion != MachineFingerprintSchemaVersion {
		return contractError(errors.New("standard machine fingerprint schema version is unsupported"))
	}
...
func (c MachineCompute) Validate() error {
	...
	if c.VCPU == 0 || c.Sockets == 0 || c.CoresPerSocket == 0 || c.ThreadsPerCore == 0 || c.NUMANodes == 0 {
		return contractError(errors.New("standard machine compute topology is invalid"))
	}
	...
	if guest > configured {
		return conflictError(errors.New("standard machine compute memory is contradictory"))
	}
	return nil
}
...
func (n MachineNetwork) Validate() error {
	...
	if n.MTU == 0 || n.ReceiveQueues == 0 || n.TransmitQueues == 0 || n.EgressCeilingBits < n.EgressFloorBits {
		return conflictError(errors.New("standard machine network bounds are contradictory"))
	}
	return nil
}
...
func (c MachineConfiguration) Validate() error {
	...
	if len(c.Toolchains) == 0 || len(c.Toolchains) > MachineToolchainMaximum {
		return contractError(errors.New("standard machine toolchain inventory is invalid"))
	}
	for index := range c.Toolchains {
		...
		if index > 0 && c.Toolchains[index-1].Tool >= c.Toolchains[index].Tool {
			return conflictError(errors.New("standard machine toolchains are not canonical"))
		}
	}
	return nil
}
...
func (r MachineRuntime) ValidateFor(configuration MachineConfiguration) error {
	...
	if r.Uptime.IsZero() || r.MemoryAvailableBytes.Uint64() > guest || r.DiskAvailableBytes.Uint64() > capacity {
		return conflictError(errors.New("standard machine runtime is contradictory"))
	}
	return nil
}
...
func (e MachineProbeExecution) Validate() error {
	...
	if e.ScriptBytes.Uint64() == 0 {
		return conflictError(errors.New("standard successful machine probe execution has an empty script"))
	}
	if e.ExitCode != 0 {
		return conflictError(errors.New("standard successful machine probe execution has nonzero exit"))
	}
	return nil
}
...
func (r MachineProbeReport) Validate() error {
	if r.SchemaVersion != MachineProbeSchemaVersion {
		return contractError(errors.New("standard machine probe schema version is unsupported"))
	}
...
func (r *MachineProbeReport) UnmarshalJSON(data []byte) error {
	if r == nil {
		return jsonError(errors.New("nil standard machine probe report receiver"))
	}
...
func (s MachineExecutionSettings) Validate() error {
	if s.LogicalCPUCount == 0 {
		return contractError(errors.New("standard machine execution settings lack logical CPUs"))
	}
...
func (o MachineObservation) Validate() error {
	if o.SchemaVersion != MachineProbeSchemaVersion {
		return contractError(errors.New("standard machine observation schema version is unsupported"))
	}
	...
	if err != nil || want != o.Fingerprint {
		return conflictError(errors.New("standard machine observation fingerprint differs from configuration"), err)
	}
	return nil
}
...
func (g MachineGeneration) Validate() error {
	if g.SchemaVersion != MachineProbeSchemaVersion {
		return contractError(errors.New("standard machine generation schema version is unsupported"))
	}
	...
	if err != nil || want != g.Fingerprint || g.ObservationCount == 0 {
		return conflictError(errors.New("standard machine generation is contradictory"), err)
	}
...
func validateMachineGenerationOrder(first, last temporal.Instant) error {
	...
	if lastNanoseconds < firstNanoseconds {
		return conflictError(errors.New("standard machine generation observation order is contradictory"))
	}
	return nil
}
...
func (f *MachineChangeField) UnmarshalJSON(data []byte) error {
	if f == nil {
		return jsonError(errors.New("nil standard machine change field receiver"))
	}
...
func (c MachineChange) Validate() error {
	...
	if c.Before == c.After {
		return conflictError(errors.New("standard machine change does not change a fact"))
	}
	return nil
}
...
func (t MachineGenerationTransition) Validate() error {
	...
	if t.PreviousGenerationID == t.CurrentGenerationID || len(t.Changes) == 0 || len(t.Changes) > MachineChangeMaximum {
		return conflictError(errors.New("standard machine generation transition is invalid"))
	}
	for index := range t.Changes {
		...
		if index > 0 && t.Changes[index-1].Field >= t.Changes[index].Field {
			return conflictError(errors.New("standard machine changes are not canonical"))
		}
	}
	return nil
}
...
func (m CurrentMachine) Validate() error {
	...
	if m.Generation.ID != m.Observation.GenerationID || m.Generation.Fingerprint != m.Observation.Fingerprint || m.Generation.Configuration.Identity.ID != m.Observation.Configuration.Identity.ID {
		return conflictError(errors.New("standard current machine generation differs from observation"))
	}
	if m.Transition == nil {
		return nil
	}
	...
	if m.Transition.CurrentGenerationID != m.Generation.ID {
		return conflictError(errors.New("standard current machine transition differs from generation"))
	}
	return nil
}
