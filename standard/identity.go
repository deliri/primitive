...
func (o OptionalGitOrigin) Validate() error {
	...
	if o.Commit == nil || o.At == nil {
		return contractError(errors.New("standard optional git origin is incomplete"))
	}
	if err := errors.Join(o.Commit.Validate(), o.At.Validate()); err != nil {
		return contractError(err)
	}
...
func DeriveExperimentID(run RunID, probe ProbeIdentity) (ExperimentID, error) {
	...
	if probe.Role != ProbeRoleExperiment {
		return ExperimentID{}, contractError(errors.New("standard derived experiment probe is not an experiment"))
	}
...
func validateUUIDIdentity(value primitiveid.UUIDv7, kind string) error {
	if err := value.Validate(); err != nil {
		return contractError(errors.New("standard "+kind+" identity is invalid"), err)
	}
	return nil
}
...
func (i *RequestIdentity) UnmarshalJSON(data []byte) error {
	if i == nil {
		return jsonError(errors.New("nil standard request identity receiver"))
	}
...
func (i *RequestNonce) UnmarshalJSON(data []byte) error {
	if i == nil {
		return jsonError(errors.New("nil standard request nonce receiver"))
	}
	var value primitiveid.UUIDv7
	if err := json.Unmarshal(data, &value); err != nil {
		return jsonError(err)
...
func (i *RunID) UnmarshalJSON(data []byte) error {
	if i == nil {
		return jsonError(errors.New("nil standard run identity receiver"))
	}
	var value primitiveid.UUIDv7
	if err := json.Unmarshal(data, &value); err != nil {
		return jsonError(err)
...
func (i *ExperimentID) UnmarshalJSON(data []byte) error {
	if i == nil {
		return jsonError(errors.New("nil standard experiment identity receiver"))
	}
	var value primitiveid.UUIDv7
	if err := json.Unmarshal(data, &value); err != nil {
		return jsonError(err)
...
func (i *ObservationID) UnmarshalJSON(data []byte) error {
	if i == nil {
		return jsonError(errors.New("nil standard observation identity receiver"))
	}
	var value primitiveid.UUIDv7
	if err := json.Unmarshal(data, &value); err != nil {
		return jsonError(err)
...
func (i *MachineID) UnmarshalJSON(data []byte) error {
	if i == nil {
		return jsonError(errors.New("nil standard machine identity receiver"))
	}
	var value primitiveid.UUIDv7
	if err := json.Unmarshal(data, &value); err != nil {
		return jsonError(err)
...
func (i *MachineGenerationID) UnmarshalJSON(data []byte) error {
	if i == nil {
		return jsonError(errors.New("nil standard machine generation identity receiver"))
	}
	var value primitiveid.UUIDv7
	if err := json.Unmarshal(data, &value); err != nil {
		return jsonError(err)
...
func (i *MachineObservationID) UnmarshalJSON(data []byte) error {
	if i == nil {
		return jsonError(errors.New("nil standard machine observation identity receiver"))
	}
	var value primitiveid.UUIDv7
	if err := json.Unmarshal(data, &value); err != nil {
		return jsonError(err)
