...
func evolutionRefusalCases() []evolutionHostileCase {
	return []evolutionHostileCase{
		{name: "refusal package key differs", primary: evolutionClassRefusal, mutate: mutateEvolutionPackageKey, wantErr: core.ErrStandardConflict},
		{name: "refusal subject project differs", primary: evolutionClassRefusal, mutate: mutateEvolutionSubjectProject, wantErr: core.ErrStandardConflict},
		{name: "refusal subject repository differs", primary: evolutionClassRefusal, mutate: mutateEvolutionSubjectRepository, wantErr: core.ErrStandardConflict},
		{name: "refusal package group differs", primary: evolutionClassRefusal, mutate: mutateEvolutionGroup, wantErr: core.ErrStandardConflict},
		{name: "refusal package language differs", primary: evolutionClassRefusal, mutate: mutateEvolutionLanguage, wantErr: core.ErrStandardConflict},
		{name: "refusal code package path differs", primary: evolutionClassRefusal, mutate: mutateEvolutionCodePath, wantErr: core.ErrStandardConflict},
		{name: "refusal source analyzer generation differs", primary: evolutionClassRefusal, mutate: mutateEvolutionAnalyzerGeneration, wantErr: core.ErrStandardConflict},
		{name: "refusal before schema is unset", primary: evolutionClassRefusal, mutate: mutateEvolutionBeforeSchema, wantErr: core.ErrStandardContract},
		{name: "refusal after schema is future", primary: evolutionClassRefusal, mutate: mutateEvolutionAfterSchema, wantErr: core.ErrStandardContract},
		{name: "refusal source analysis names another revision", primary: evolutionClassRefusal, mutate: mutateEvolutionSourceRevision, wantErr: core.ErrStandardConflict},
	}
}
...
func evolutionBoundaryCases() []evolutionHostileCase {
	return []evolutionHostileCase{
		...
		{name: "boundary test declarations exceed per-file maximum by one", primary: evolutionClassBoundary, mutate: mutateEvolutionDeclarationsAbove, wantErr: core.ErrStandardConflict},
		{name: "boundary test declarations reach uint32 extreme", primary: evolutionClassBoundary, mutate: mutateEvolutionDeclarationsExtreme, wantErr: core.ErrStandardConflict},
		...
		{name: "boundary coverage exceeds maximum by one", primary: evolutionClassBoundary, mutate: mutateEvolutionCoverageAbove, wantErr: core.ErrStandardContract},
		...
		{name: "boundary review candidates exceed maximum by one", primary: evolutionClassBoundary, mutate: mutateEvolutionCandidateCountAbove, wantErr: core.ErrStandardContract},
		{name: "boundary evidence surfaces are absent", primary: evolutionClassBoundary, mutate: mutateEvolutionSurfacesZero, wantErr: core.ErrStandardContract},
		...
		{name: "boundary evidence surfaces exceed maximum by one", primary: evolutionClassBoundary, mutate: mutateEvolutionSurfacesAbove, wantErr: core.ErrStandardContract},
	}
}
...
func evolutionSurfaces(t testing.TB, template EvidenceSurface, count int) []EvidenceSurface {
	t.Helper()
	values := make([]EvidenceSurface, count)
	for index := range values {
