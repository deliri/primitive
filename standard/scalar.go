...
func (v Identifier) Validate() error {
	if !validIdentifier(v.value, IdentifierMaximumBytes) {
		return contractError(errors.New("standard identifier is invalid"))
	}
	return nil
}

func (v Name) Validate() error {
	return validateHumanText(v.value, NameMaximumBytes, "standard name is invalid")
}

func (v Text) Validate() error {
	return validateHumanText(v.value, TextMaximumBytes, "standard text is invalid")
}

func (v SourcePath) Validate() error {
	if !validSourcePath(v.value) {
		return contractError(errors.New("standard source path is invalid"))
	}
	return nil
}
...
func (v RepositoryIdentity) Validate() error {
	if !validOpaqueToken(v.value, RepositoryIdentityMaximumBytes) {
		return contractError(errors.New("standard repository identity is invalid"))
	}
	return nil
}
...
func (v *Identifier) UnmarshalJSON(data []byte) error {
	if v == nil {
		return jsonError(errors.New("nil standard identifier receiver"))
	}
...
func (v *Name) UnmarshalJSON(data []byte) error {
	if v == nil {
		return jsonError(errors.New("nil standard name receiver"))
	}
	return decodeScalar(data, func(raw string) error {
...
func (v *Text) UnmarshalJSON(data []byte) error {
	if v == nil {
		return jsonError(errors.New("nil standard text receiver"))
	}
	return decodeScalar(data, func(raw string) error {
...
func (v *SourcePath) UnmarshalJSON(data []byte) error {
	if v == nil {
		return jsonError(errors.New("nil standard source path receiver"))
	}
	return decodeScalar(data, func(raw string) error {
...
func (v *RepositoryIdentity) UnmarshalJSON(data []byte) error {
	if v == nil {
		return jsonError(errors.New("nil standard repository identity receiver"))
	}
	return decodeScalar(data, func(raw string) error {
