...
Approved release: **v2026.1.33**. See [release notes](release_v2026.1.33.md),
[the reviewed Currency report](currency_upgrade_20260909.md), and
[execution evidence](currency_upgrade_20260909_evidence.json).
The user approved the Currency slice and moving to **ID** next.
...
Process, Core, Contextstate, Controlwire, Keygen, Release, Objectstore, Chit, Controlplane, Shutdown, and Currency.
...
in v2026.1.31; Shutdown in v2026.1.32; Currency in v2026.1.33. The separate v2026.1.30 Manual grammar change is a scoped addition,
...
The user approved the v2026.1.33 Currency release. Each new slice retains
