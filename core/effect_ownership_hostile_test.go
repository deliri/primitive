...
func declaredRealWorldImports() (realWorldImportInventory, error) {
	contracts := []realWorldImportContract{
		...
		realWorldImportOwners(realWorldSubstrateClock, PackageAWSIdentity, PackageGoogleIdentity, PackageTemporal, PackageTimeProof),
...
func declaredRealWorldCalls() (realWorldCallInventory, error) {
	contracts := []realWorldCallUse{
		...
		{owner: PackageFilestore, substrate: realWorldSubstrateOperatingSystem, selector: "Lstat", count: 3},
		{owner: PackageFilestore, substrate: realWorldSubstrateOperatingSystem, selector: "NewFile", count: 1},
		{owner: PackageFilestore, substrate: realWorldSubstrateOperatingSystem, selector: "OpenRoot", count: 4},
		{owner: PackageFilestore, substrate: realWorldSubstrateOperatingSystem, selector: "SameFile", count: 12},
		{owner: PackageFilestore, substrate: realWorldSubstrateOperatingSystem, selector: "Stat", count: 3},
		...
		{owner: PackageHostFacts, substrate: realWorldSubstrateOperatingSystem, selector: "Executable", count: 1},
		{owner: PackageHostFacts, substrate: realWorldSubstrateOperatingSystem, selector: "Getwd", count: 1},
		{owner: PackageHostFacts, substrate: realWorldSubstrateOperatingSystem, selector: "LookupEnv", count: 1},
		...
		{owner: PackageGoToolchain, substrate: realWorldSubstrateOperatingSystem, selector: "OpenFile", count: 1},
		{owner: PackageGoToolchain, substrate: realWorldSubstrateOperatingSystem, selector: "OpenInRoot", count: 1},
		{owner: PackageGoToolchain, substrate: realWorldSubstrateOperatingSystem, selector: "Remove", count: 1},
		...
		{owner: PackageAWSIdentity, substrate: realWorldSubstrateClock, selector: "Parse", count: 2},
		...
		{owner: PackageFilestore, substrate: realWorldSubstrateUnix, selector: "Close", count: 4},
		{owner: PackageFilestore, substrate: realWorldSubstrateUnix, selector: "Fstat", count: 1},
		{owner: PackageFilestore, substrate: realWorldSubstrateUnix, selector: "Open", count: 2},
		...
		{owner: PackageFilestore, substrate: realWorldSubstrateWindows, selector: "GetFileInformationByHandle", count: 1},
		{owner: PackageFilestore, substrate: realWorldSubstrateWindows, selector: "Handle", count: 1},
