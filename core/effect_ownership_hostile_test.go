...
func declaredRealWorldCalls() (realWorldCallInventory, error) {
	contracts := []realWorldCallUse{
		...
		{owner: PackageFilestore, substrate: realWorldSubstrateOperatingSystem, selector: "OpenRoot", count: 2},
		{owner: PackageFilestore, substrate: realWorldSubstrateOperatingSystem, selector: "SameFile", count: 11},
		...
		{owner: PackageFilestore, substrate: realWorldSubstrateUnix, selector: "Close", count: 1},
		{owner: PackageFilestore, substrate: realWorldSubstrateUnix, selector: "Open", count: 1},
