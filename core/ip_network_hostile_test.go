...
func TestIPNetworkParserHostileCanonicalBoundaryTable(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "IPv4 full width prefix is an alternate exact-address spelling", wire: "192.0.2.1/32"},
		{name: "IPv6 whole address space", wire: "::/0", want: "::/0"},
		{name: "IPv6 interior masked prefix", wire: "2001:db8::/32", want: "2001:db8::/32"},
		{name: "IPv6 full width prefix is an alternate exact-address spelling", wire: "2001:db8::1/128"},
