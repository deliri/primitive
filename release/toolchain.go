...
const goToolchainVersionPrimitive2026 = "go1.27.1"
...
const (
	...
	// GoToolchainPrimitive2026 identifies the exact reviewed Go 1.27.1 toolchain.
	GoToolchainPrimitive2026
	goToolchainLimit
)

func goToolchainLabels() [goToolchainLimit]string {
	return [...]string{GoToolchainPrimitive2026: "go-1.27.1"}
}
