...
const goToolchainVersionPrimitive2026 = "go1.26.5"
...
const (
	...
	// GoToolchainPrimitive2026 identifies the exact reviewed Go 1.26.5 toolchain.
	GoToolchainPrimitive2026
	goToolchainLimit
)

func goToolchainLabels() [goToolchainLimit]string {
	return [...]string{GoToolchainPrimitive2026: "go-1.26.5"}
}
