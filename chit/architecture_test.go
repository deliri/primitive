...
type chitContractInventory struct {
	...
	ManifestEntryVerifier        streamingState[ManifestEntryVerifier]
	VerifiedManifestEntry        capabilityWrapper[VerifiedManifestEntry]
	ManifestAdmission            protocolFact[ManifestAdmission]
	ManifestAdmissionAccumulator streamingState[ManifestAdmissionAccumulator]
	VerifiedManifestAdmission    capabilityWrapper[VerifiedManifestAdmission]
	manifestAdmissionWire        internalFlow[manifestAdmissionWire]
...
var _ = chitContractInventory{}.manifestAdmissionWire
