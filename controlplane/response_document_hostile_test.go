...
func TestAuthenticatedResponseProducerExhaustsValidDecisionDomains(t *testing.T) {
	...
	cases := []responseValidCase{
		...
		{name: "product alpha offering survives signed round trip", mutate: responseOfferingMutation(controlplaneOffering(t, 1))},
		{name: "product beta offering survives signed round trip", mutate: responseOfferingMutation(controlplaneOffering(t, 2))},
		{name: "product gamma offering survives signed round trip", mutate: responseOfferingMutation(controlplaneOffering(t, 3))},
