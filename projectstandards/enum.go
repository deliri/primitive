...
func (s DeliveryState) Validate() error {
	return validateEnum(uint8(s), deliveryLabels(), "project standards delivery state is invalid")
}
...
func (s DeliveryState) MarshalJSON() ([]byte, error) {
	return marshalEnum(uint8(s), deliveryLabels(), "project standards delivery state is invalid")
}
func (s *DeliveryState) UnmarshalJSON(data []byte) error {
	if s == nil {
		return jsonError(errors.New("nil project standards delivery state receiver"))
	}
	value, err := unmarshalEnum(data, deliveryLabels(), "project standards delivery state is invalid")
	if err == nil {
...
func (o Outcome) Validate() error {
	return validateEnum(uint8(o), outcomeLabels(), "project standards outcome is invalid")
}
...
func (o Outcome) MarshalJSON() ([]byte, error) {
	return marshalEnum(uint8(o), outcomeLabels(), "project standards outcome is invalid")
}
func (o *Outcome) UnmarshalJSON(data []byte) error {
	if o == nil {
		return jsonError(errors.New("nil project standards outcome receiver"))
	}
	value, err := unmarshalEnum(data, outcomeLabels(), "project standards outcome is invalid")
	if err == nil {
		*o = Outcome(value)
	}
	return err
...
func (p ReportPlacement) Validate() error {
	return validateEnum(uint8(p), reportPlacementLabels(), "project standards report placement is invalid")
}
...
func (p ReportPlacement) MarshalJSON() ([]byte, error) {
	return marshalEnum(uint8(p), reportPlacementLabels(), "project standards report placement is invalid")
}
func (p *ReportPlacement) UnmarshalJSON(data []byte) error {
	if p == nil {
		return jsonError(errors.New("nil project standards report placement receiver"))
	}
	value, err := unmarshalEnum(data, reportPlacementLabels(), "project standards report placement is invalid")
	if err == nil {
