...
func (o OptionalGitOrigin) Validate() error {
	...
	if o.Commit == nil || o.At == nil {
		return contractError(errors.New("project standards optional git origin is incomplete"))
	}
	if err := errors.Join(o.Commit.Validate(), o.At.Validate()); err != nil {
		return contractError(err)
	}
...
func DeriveExperimentID(run RunID, probe ProbeIdentity) (ExperimentID, error) {
	...
	if probe.Role != ProbeRoleExperiment {
		return ExperimentID{}, contractError(errors.New("project standards derived experiment probe is not an experiment"))
	}
	canonical, err := core.MarshalCanonicalJSONDocument(struct {
...
func (i *RequestIdentity) UnmarshalJSON(data []byte) error {
	if i == nil {
		return jsonError(errors.New("nil project standards request identity receiver"))
	}
...
func (i *RunID) UnmarshalJSON(data []byte) error {
	if i == nil {
		return jsonError(errors.New("nil project standards run identity receiver"))
	}
	var value primitiveid.UUIDv7
	if err := json.Unmarshal(data, &value); err != nil {
		return jsonError(err)
...
func (i *ExperimentID) UnmarshalJSON(data []byte) error {
	if i == nil {
		return jsonError(errors.New("nil project standards experiment identity receiver"))
	}
	var value primitiveid.UUIDv7
	if err := json.Unmarshal(data, &value); err != nil {
		return jsonError(err)
...
func (i *ObservationID) UnmarshalJSON(data []byte) error {
	if i == nil {
		return jsonError(errors.New("nil project standards observation identity receiver"))
	}
	var value primitiveid.UUIDv7
	if err := json.Unmarshal(data, &value); err != nil {
		return jsonError(err)
...
func (i *MachineID) UnmarshalJSON(data []byte) error {
	if i == nil {
		return jsonError(errors.New("nil project standards machine identity receiver"))
	}
	var value primitiveid.UUIDv7
	if err := json.Unmarshal(data, &value); err != nil {
		return jsonError(err)
...
func (i *MachineGenerationID) UnmarshalJSON(data []byte) error {
	if i == nil {
		return jsonError(errors.New("nil project standards machine generation identity receiver"))
	}
	var value primitiveid.UUIDv7
	if err := json.Unmarshal(data, &value); err != nil {
		return jsonError(err)
...
func (i *MachineObservationID) UnmarshalJSON(data []byte) error {
	if i == nil {
		return jsonError(errors.New("nil project standards machine observation identity receiver"))
	}
	var value primitiveid.UUIDv7
	if err := json.Unmarshal(data, &value); err != nil {
		return jsonError(err)
