...
func fixtureCatalog(t testing.TB) Catalog {
	...
	featureID := fixtureIdentifier(t, "typed-project-standards")
	...
	usage := Usage{
		ID: fixtureIdentifier(t, "read-project-standards"), Title: fixtureName(t, "Read engineering context"),
	...
	reference := CodeReference{Path: fixturePath(t, "projectstandards/catalog.go")}
	assurance := Assurance{
	...
	packageSnapshot := PackageSnapshot{
		...
		Package:       Package{Key: fixtureIdentifier(t, "project-standards-package"), Subject: subject, Revision: commit, GroupID: groupID, Language: fixtureName(t, "Go"), Knowledge: knowledge},
		Code:          Code{Package: path, Inventory: inventory},
		Evidence:      Evidence{Package: path, Surfaces: []ProjectStandardsEvidenceSurface{surface}},
	}
	...
	project := Project{
		...
		Capabilities: []ProjectCapability{{FeatureID: featureID, Contributions: []PackageContribution{{Package: path, FeatureID: featureID, Role: fixtureText(t, "Defines and validates the shared Project standards contract."), SurfaceIDs: []Identifier{surfaceID}}}}},
