...
func filestoreIngressProofs() []filestoreIngressProof {
	entries := []filestoreIngressProof{
		...
		{door: reflect.ValueOf(filestore.NewDirectoryEntryMaximum), fuzz: FuzzLexicalWalkCardinalitySemanticClosure},
		{door: reflect.ValueOf(filestore.Walk), fuzz: FuzzLexicalWalkCardinalitySemanticClosure},
