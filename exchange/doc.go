...
// meaning and custody of every payload. In particular, object names, digests,
// cloud generation conditions, verification, and commitment belong to an
// object-store package, not Exchange.
//
