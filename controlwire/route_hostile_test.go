...
func TestRouteFamilyWireContractAcceptsEveryPublishedTokenAndRejectsHostileDocuments(t *testing.T) {
	...
	families := []RouteFamily{
		...
		RouteFamilyReleasePublicationCompletions, RouteFamilyUpdateChecks, RouteFamilyUpgrades, RouteFamilyActivations, RouteFamilyUpgradeReports, RouteFamilyUpgradeEvidence,
	}
...
func TestRouteContractProjectsExactlyItsTwoFacts(t *testing.T) {
	...
	families := []RouteFamily{
		...
		RouteFamilyUpdateChecks, RouteFamilyUpgrades, RouteFamilyActivations, RouteFamilyUpgradeReports, RouteFamilyUpgradeEvidence,
	}
