// Package cloudidentity acquires bounded outbound identity and OAuth access
// bearers from Google Cloud metadata or regional AWS STS.
//
// Each token is opaque and redacted. Cloudidentity can also validate the exact
