...
type cloudidentityStructInventory struct {
	...
	AmazonExpirationElement          providerWire[amazonExpirationElement]
	AmazonResponse                   providerWire[amazonResponse]
	AmazonResult                     providerWire[amazonResult]
	AmazonResponseMetadata           providerWire[amazonResponseMetadata]
	AmazonRequestIDElement           providerWire[amazonRequestIDElement]
