...
func TestProviderOutboundBindingHostileBoundaryTable(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Stripe explicit default port is noncanonical", host: StripeAPIHost + ":443", path: "/v1/payment_intents", media: "application/x-www-form-urlencoded", response: "application/json", validator: providerBindingStripe, wantErr: core.ErrProviderWireBinding},
