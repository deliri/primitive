...
func (r MachineIOPS) Validate() error {
	if r == 0 {
		return contractError(errors.New("run protocol machine IOPS is zero"))
	}
	return nil
}
...
func (r MachineBytesPerSecond) Validate() error {
	if r == 0 {
		return contractError(errors.New("run protocol machine byte rate is zero"))
	}
	return nil
}
...
func (r MachineBitsPerSecond) Validate() error {
	if r == 0 {
		return contractError(errors.New("run protocol machine bit rate is zero"))
	}
	return nil
}
...
func (k MachineToolchainKind) Validate() error {
	return validateEnum(uint8(k), machineToolchainLabels(), machineToolchainKindInvalidDiagnostic)
}
...
func (k MachineToolchainKind) MarshalJSON() ([]byte, error) {
	return marshalEnum(uint8(k), machineToolchainLabels(), machineToolchainKindInvalidDiagnostic)
}
func (k *MachineToolchainKind) UnmarshalJSON(data []byte) error {
	if k == nil {
		return jsonError(errors.New("nil run protocol machine toolchain kind receiver"))
	}
	value, err := unmarshalEnum(data, machineToolchainLabels(), machineToolchainKindInvalidDiagnostic)
	if err == nil {
...
func (m MachineInstallMode) Validate() error {
	return validateEnum(uint8(m), machineInstallModeLabels(), machineInstallModeInvalidDiagnostic)
}
...
func (m MachineInstallMode) MarshalJSON() ([]byte, error) {
	return marshalEnum(uint8(m), machineInstallModeLabels(), machineInstallModeInvalidDiagnostic)
}
func (m *MachineInstallMode) UnmarshalJSON(data []byte) error {
	if m == nil {
		return jsonError(errors.New("nil run protocol machine install mode receiver"))
	}
	value, err := unmarshalEnum(data, machineInstallModeLabels(), machineInstallModeInvalidDiagnostic)
	if err == nil {
...
func machineProvisioningLabels() []string {
	return []string{"", "standard", "spot", "preemptible"}
}
func (m MachineProvisioningModel) Validate() error {
	return validateEnum(uint8(m), machineProvisioningLabels(), machineProvisioningModelInvalidDiagnostic)
}
...
func (m MachineProvisioningModel) MarshalJSON() ([]byte, error) {
	return marshalEnum(uint8(m), machineProvisioningLabels(), machineProvisioningModelInvalidDiagnostic)
}
func (m *MachineProvisioningModel) UnmarshalJSON(data []byte) error {
	if m == nil {
		return jsonError(errors.New("nil run protocol machine provisioning model receiver"))
	}
	value, err := unmarshalEnum(data, machineProvisioningLabels(), machineProvisioningModelInvalidDiagnostic)
	if err == nil {
...
func (m MachineMaintenancePolicy) Validate() error {
	return validateEnum(uint8(m), machineMaintenanceLabels(), machineMaintenancePolicyInvalidDiagnostic)
}
...
func (m MachineMaintenancePolicy) MarshalJSON() ([]byte, error) {
	return marshalEnum(uint8(m), machineMaintenanceLabels(), machineMaintenancePolicyInvalidDiagnostic)
}
func (m *MachineMaintenancePolicy) UnmarshalJSON(data []byte) error {
	if m == nil {
		return jsonError(errors.New("nil run protocol machine maintenance policy receiver"))
	}
	value, err := unmarshalEnum(data, machineMaintenanceLabels(), machineMaintenancePolicyInvalidDiagnostic)
	if err == nil {
...
func (f MachineFingerprint) Validate() error {
	if f.SchemaVersion != MachineFingerprintSchemaVersion {
		return contractError(errors.New("run protocol machine fingerprint schema version is unsupported"))
	}
...
func (c MachineCompute) Validate() error {
	...
	if c.VCPU == 0 || c.Sockets == 0 || c.CoresPerSocket == 0 || c.ThreadsPerCore == 0 || c.NUMANodes == 0 {
		return contractError(errors.New("run protocol machine compute topology is invalid"))
	}
	...
	if guest > configured {
		return conflictError(errors.New("run protocol machine compute memory is contradictory"))
	}
	return nil
}
...
func (n MachineNetwork) Validate() error {
	...
	if n.MTU == 0 || n.ReceiveQueues == 0 || n.TransmitQueues == 0 || n.EgressCeilingBits < n.EgressFloorBits {
		return conflictError(errors.New("run protocol machine network bounds are contradictory"))
	}
	return nil
}
...
// These internal projections keep canonical fingerprint order independent of
// the in-memory field layout that fieldalignment is free to optimize. Pointer
// fields have one size, so the mechanically efficient layout is also the
// compiler-visible protocol order pinned by the fingerprint ratchet.
type machineFingerprintIdentityWire struct {
	ID          *MachineID     `json:"id"`
	Provider    *core.Offering `json:"provider"`
	Project     *Identifier    `json:"project"`
	Instance    *Identifier    `json:"instance"`
...
type machineFingerprintToolchainWire struct {
	Tool             *MachineToolchainKind `json:"tool"`
	Version          *Name                 `json:"version"`
	Platform         *Name                 `json:"platform"`
	InstallMode      *MachineInstallMode   `json:"install_mode"`
...
type machineConfigurationFingerprintWire struct {
	Identity   *machineFingerprintIdentityWire    `json:"identity"`
	Compute    *MachineCompute                    `json:"compute"`
	System     *MachineSystem                     `json:"system"`
	Storage    *MachineStorage                    `json:"storage"`
	Network    *MachineNetwork                    `json:"network"`
	Lifecycle  *MachineLifecycleSecurity          `json:"lifecycle_security"`
	Toolchains *[]machineFingerprintToolchainWire `json:"toolchains"`
}
...
func (c MachineConfiguration) Validate() error {
	...
	if len(c.Toolchains) == 0 || len(c.Toolchains) > MachineToolchainMaximum {
		return contractError(errors.New("run protocol machine toolchain inventory is invalid"))
	}
	for index := range c.Toolchains {
		...
		if index > 0 && c.Toolchains[index-1].Tool >= c.Toolchains[index].Tool {
			return conflictError(errors.New("run protocol machine toolchains are not canonical"))
		}
	}
	return nil
}
...
func (c MachineConfiguration) Fingerprint() (MachineFingerprint, error) {
	...
	identity := machineFingerprintIdentityWire{
		ID: &c.Identity.ID, Provider: &c.Identity.Provider, Project: &c.Identity.Project,
		Instance: &c.Identity.Instance, Zone: &c.Identity.Zone, MachineType: &c.Identity.MachineType,
	}
	toolchains := make([]machineFingerprintToolchainWire, len(c.Toolchains))
	for index := range c.Toolchains {
		toolchain := &c.Toolchains[index]
		toolchains[index] = machineFingerprintToolchainWire{
			Tool: &toolchain.Tool, Version: &toolchain.Version, Platform: &toolchain.Platform,
			InstallMode: &toolchain.InstallMode, ExecutableSHA256: &toolchain.ExecutableSHA256,
		}
	}
	wire := machineConfigurationFingerprintWire{
		Identity: &identity, Compute: &c.Compute, System: &c.System, Storage: &c.Storage,
		Network: &c.Network, Lifecycle: &c.Lifecycle, Toolchains: &toolchains,
	}
...
func (r MachineRuntime) ValidateFor(configuration MachineConfiguration) error {
	...
	if r.Uptime.IsZero() || r.MemoryAvailableBytes.Uint64() > guest || r.DiskAvailableBytes.Uint64() > capacity {
		return conflictError(errors.New("run protocol machine runtime is contradictory"))
	}
	return nil
}
...
func (e MachineProbeExecution) Validate() error {
	...
	if e.ScriptBytes.Uint64() == 0 {
		return conflictError(errors.New("run protocol successful machine probe execution has an empty script"))
	}
	if e.ExitCode != 0 {
		return conflictError(errors.New("run protocol successful machine probe execution has nonzero exit"))
	}
	return nil
}
...
func (r MachineProbeReport) Validate() error {
	if r.SchemaVersion != MachineProbeSchemaVersion {
		return contractError(errors.New("run protocol machine probe schema version is unsupported"))
	}
...
const MachineProbeReportJSONMaximumBytes = 1 << 20
...
func (r MachineProbeReport) MarshalJSON() ([]byte, error) {
	...
	if err != nil || len(encoded) > MachineProbeReportJSONMaximumBytes {
		return nil, jsonError(err)
	}
	return encoded, nil
}
...
func (r *MachineProbeReport) UnmarshalJSON(data []byte) error {
	if r == nil {
		return jsonError(errors.New("nil run protocol machine probe report receiver"))
	}
	maximum, err := core.NewByteCount(MachineProbeReportJSONMaximumBytes)
	if err != nil {
		return jsonError(err)
	}
	limits := aboutJSONLimits()
	limits.DocumentMaximumBytes = maximum
	wire, err := core.DecodeStrictJSONStructure[machineProbeReportWire](data, limits)
	if err != nil {
		return jsonError(err)
	}
...
func (s MachineExecutionSettings) Validate() error {
	if s.LogicalCPUCount == 0 {
		return contractError(errors.New("run protocol machine execution settings lack logical CPUs"))
	}
...
func (o MachineObservation) Validate() error {
	if o.SchemaVersion != MachineProbeSchemaVersion {
		return contractError(errors.New("run protocol machine observation schema version is unsupported"))
	}
	...
	if err != nil || want != o.Fingerprint {
		return conflictError(errors.New("run protocol machine observation fingerprint differs from configuration"), err)
	}
	return nil
}
...
func (g MachineGeneration) Validate() error {
	if g.SchemaVersion != MachineProbeSchemaVersion {
		return contractError(errors.New("run protocol machine generation schema version is unsupported"))
	}
	...
	if err != nil || want != g.Fingerprint || g.ObservationCount == 0 {
		return conflictError(errors.New("run protocol machine generation is contradictory"), err)
	}
...
func validateMachineGenerationOrder(first, last temporal.Instant) error {
	...
	if lastNanoseconds < firstNanoseconds {
		return conflictError(errors.New("run protocol machine generation observation order is contradictory"))
	}
	return nil
}
...
func (f MachineChangeField) Validate() error {
	return validateEnum(uint8(f), machineChangeFieldLabels(), machineChangeFieldInvalidDiagnostic)
}
...
func (f MachineChangeField) MarshalJSON() ([]byte, error) {
	return marshalEnum(uint8(f), machineChangeFieldLabels(), machineChangeFieldInvalidDiagnostic)
}
func (f *MachineChangeField) UnmarshalJSON(data []byte) error {
	if f == nil {
		return jsonError(errors.New("nil run protocol machine change field receiver"))
	}
	value, err := unmarshalEnum(data, machineChangeFieldLabels(), machineChangeFieldInvalidDiagnostic)
	if err == nil {
...
func (c MachineChange) Validate() error {
	...
	if c.Before == c.After {
		return conflictError(errors.New("run protocol machine change does not change a fact"))
	}
	return nil
}
...
func (t MachineGenerationTransition) Validate() error {
	...
	if t.PreviousGenerationID == t.CurrentGenerationID || len(t.Changes) == 0 || len(t.Changes) > MachineChangeMaximum {
		return conflictError(errors.New("run protocol machine generation transition is invalid"))
	}
	for index := range t.Changes {
		...
		if index > 0 && t.Changes[index-1].Field >= t.Changes[index].Field {
			return conflictError(errors.New("run protocol machine changes are not canonical"))
		}
	}
	return nil
}
...
func (m CurrentMachine) Validate() error {
	...
	if m.Generation.ID != m.Observation.GenerationID || m.Generation.Fingerprint != m.Observation.Fingerprint || m.Generation.Configuration.Identity.ID != m.Observation.Configuration.Identity.ID {
		return conflictError(errors.New("run protocol current machine generation differs from observation"))
	}
	if m.Transition == nil {
		return nil
	}
	...
	if m.Transition.CurrentGenerationID != m.Generation.ID {
		return conflictError(errors.New("run protocol current machine transition differs from generation"))
	}
	return nil
}
