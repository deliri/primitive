...
func (v Identifier) Validate() error {
	if !validIdentifier(v.value, IdentifierMaximumBytes) {
		return contractError(errors.New("about identifier is invalid"))
	}
	return nil
}

func (v Name) Validate() error {
	return validateHumanText(v.value, NameMaximumBytes, "about name is invalid")
}

func (v Text) Validate() error {
	return validateHumanText(v.value, TextMaximumBytes, "about text is invalid")
}

func (v SourcePath) Validate() error {
	if !validSourcePath(v.value) {
		return contractError(errors.New("about source path is invalid"))
	}
	return nil
}
...
func (v RepositoryIdentity) Validate() error {
	if !validOpaqueToken(v.value, RepositoryIdentityMaximumBytes) {
		return contractError(errors.New("about repository identity is invalid"))
	}
	return nil
}
...
func (v *Identifier) UnmarshalJSON(data []byte) error {
	if v == nil {
		return jsonError(errors.New("nil about identifier receiver"))
	}
...
func (v *Name) UnmarshalJSON(data []byte) error {
	if v == nil {
		return jsonError(errors.New("nil about name receiver"))
	}
	return decodeScalar(data, func(raw string) error {
...
func (v *Text) UnmarshalJSON(data []byte) error {
	if v == nil {
		return jsonError(errors.New("nil about text receiver"))
	}
	return decodeScalar(data, func(raw string) error {
...
func (v *SourcePath) UnmarshalJSON(data []byte) error {
	if v == nil {
		return jsonError(errors.New("nil about source path receiver"))
	}
	return decodeScalar(data, func(raw string) error {
...
func (v *RepositoryIdentity) UnmarshalJSON(data []byte) error {
	if v == nil {
		return jsonError(errors.New("nil about repository identity receiver"))
	}
	return decodeScalar(data, func(raw string) error {
