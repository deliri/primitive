...
func (r MachineIOPS) Validate() error {
	if r == 0 {
		return contractError(errors.New("about machine IOPS is zero"))
	}
	return nil
}
...
func (r MachineBytesPerSecond) Validate() error {
	if r == 0 {
		return contractError(errors.New("about machine byte rate is zero"))
	}
	return nil
}
...
func (r MachineBitsPerSecond) Validate() error {
	if r == 0 {
		return contractError(errors.New("about machine bit rate is zero"))
	}
	return nil
}
...
func (k MachineToolchainKind) Validate() error {
	return validateEnum(uint8(k), machineToolchainLabels(), "about machine toolchain kind is invalid")
}
...
func (k MachineToolchainKind) MarshalJSON() ([]byte, error) {
	return marshalEnum(uint8(k), machineToolchainLabels(), "about machine toolchain kind is invalid")
}
func (k *MachineToolchainKind) UnmarshalJSON(data []byte) error {
	if k == nil {
		return jsonError(errors.New("nil about machine toolchain kind receiver"))
	}
	value, err := unmarshalEnum(data, machineToolchainLabels(), "about machine toolchain kind is invalid")
	if err == nil {
...
func (m MachineInstallMode) Validate() error {
	return validateEnum(uint8(m), machineInstallModeLabels(), "about machine install mode is invalid")
}
...
func (m MachineInstallMode) MarshalJSON() ([]byte, error) {
	return marshalEnum(uint8(m), machineInstallModeLabels(), "about machine install mode is invalid")
}
func (m *MachineInstallMode) UnmarshalJSON(data []byte) error {
	if m == nil {
		return jsonError(errors.New("nil about machine install mode receiver"))
	}
	value, err := unmarshalEnum(data, machineInstallModeLabels(), "about machine install mode is invalid")
	if err == nil {
...
func (m MachineProvisioningModel) Validate() error {
	return validateEnum(uint8(m), machineProvisioningLabels(), "about machine provisioning model is invalid")
}
...
func (m MachineProvisioningModel) MarshalJSON() ([]byte, error) {
	return marshalEnum(uint8(m), machineProvisioningLabels(), "about machine provisioning model is invalid")
}
func (m *MachineProvisioningModel) UnmarshalJSON(data []byte) error {
	if m == nil {
		return jsonError(errors.New("nil about machine provisioning model receiver"))
	}
	value, err := unmarshalEnum(data, machineProvisioningLabels(), "about machine provisioning model is invalid")
	if err == nil {
...
func (m MachineMaintenancePolicy) Validate() error {
	return validateEnum(uint8(m), machineMaintenanceLabels(), "about machine maintenance policy is invalid")
}
...
func (m MachineMaintenancePolicy) MarshalJSON() ([]byte, error) {
	return marshalEnum(uint8(m), machineMaintenanceLabels(), "about machine maintenance policy is invalid")
}
func (m *MachineMaintenancePolicy) UnmarshalJSON(data []byte) error {
	if m == nil {
		return jsonError(errors.New("nil about machine maintenance policy receiver"))
	}
	value, err := unmarshalEnum(data, machineMaintenanceLabels(), "about machine maintenance policy is invalid")
	if err == nil {
...
func (f MachineFingerprint) Validate() error {
	if f.SchemaVersion != MachineFingerprintSchemaVersion {
		return contractError(errors.New("about machine fingerprint schema version is unsupported"))
	}
...
func (c MachineCompute) Validate() error {
	...
	if c.VCPU == 0 || c.Sockets == 0 || c.CoresPerSocket == 0 || c.ThreadsPerCore == 0 || c.NUMANodes == 0 {
		return contractError(errors.New("about machine compute topology is invalid"))
	}
	...
	if guest > configured {
		return conflictError(errors.New("about machine compute memory is contradictory"))
	}
	return nil
}
...
func (n MachineNetwork) Validate() error {
	...
	if n.MTU == 0 || n.ReceiveQueues == 0 || n.TransmitQueues == 0 || n.EgressCeilingBits < n.EgressFloorBits {
		return conflictError(errors.New("about machine network bounds are contradictory"))
	}
	return nil
}
...
func (c MachineConfiguration) Validate() error {
	...
	if len(c.Toolchains) == 0 || len(c.Toolchains) > MachineToolchainMaximum {
		return contractError(errors.New("about machine toolchain inventory is invalid"))
	}
	for index := range c.Toolchains {
		...
		if index > 0 && c.Toolchains[index-1].Tool >= c.Toolchains[index].Tool {
			return conflictError(errors.New("about machine toolchains are not canonical"))
		}
	}
	return nil
}
...
func (r MachineRuntime) ValidateFor(configuration MachineConfiguration) error {
	...
	if r.Uptime.IsZero() || r.MemoryAvailableBytes.Uint64() > guest || r.DiskAvailableBytes.Uint64() > capacity {
		return conflictError(errors.New("about machine runtime is contradictory"))
	}
	return nil
}
...
func (e MachineProbeExecution) Validate() error {
	...
	if e.ScriptBytes.Uint64() == 0 {
		return conflictError(errors.New("about successful machine probe execution has an empty script"))
	}
	if e.ExitCode != 0 {
		return conflictError(errors.New("about successful machine probe execution has nonzero exit"))
	}
	return nil
}
...
func (r MachineProbeReport) Validate() error {
	if r.SchemaVersion != MachineProbeSchemaVersion {
		return contractError(errors.New("about machine probe schema version is unsupported"))
	}
...
func (r *MachineProbeReport) UnmarshalJSON(data []byte) error {
	if r == nil {
		return jsonError(errors.New("nil about machine probe report receiver"))
	}
...
func (o MachineObservation) Validate() error {
	if o.SchemaVersion != MachineProbeSchemaVersion {
		return contractError(errors.New("about machine observation schema version is unsupported"))
	}
	...
	if err != nil || want != o.Fingerprint {
		return conflictError(errors.New("about machine observation fingerprint differs from configuration"), err)
	}
	return nil
}
...
func (g MachineGeneration) Validate() error {
	if g.SchemaVersion != MachineProbeSchemaVersion {
		return contractError(errors.New("about machine generation schema version is unsupported"))
	}
	...
	if err != nil || want != g.Fingerprint || g.ObservationCount == 0 {
		return conflictError(errors.New("about machine generation is contradictory"), err)
	}
...
func validateMachineGenerationOrder(first, last temporal.Instant) error {
	...
	if lastNanoseconds < firstNanoseconds {
		return conflictError(errors.New("about machine generation observation order is contradictory"))
	}
	return nil
}
...
func (f MachineChangeField) Validate() error {
	return validateEnum(uint8(f), machineChangeFieldLabels(), "about machine change field is invalid")
}
...
func (f MachineChangeField) MarshalJSON() ([]byte, error) {
	return marshalEnum(uint8(f), machineChangeFieldLabels(), "about machine change field is invalid")
}
func (f *MachineChangeField) UnmarshalJSON(data []byte) error {
	if f == nil {
		return jsonError(errors.New("nil about machine change field receiver"))
	}
	value, err := unmarshalEnum(data, machineChangeFieldLabels(), "about machine change field is invalid")
	if err == nil {
...
func (c MachineChange) Validate() error {
	...
	if c.Before == c.After {
		return conflictError(errors.New("about machine change does not change a fact"))
	}
	return nil
}
...
func (t MachineGenerationTransition) Validate() error {
	...
	if t.PreviousGenerationID == t.CurrentGenerationID || len(t.Changes) == 0 || len(t.Changes) > MachineChangeMaximum {
		return conflictError(errors.New("about machine generation transition is invalid"))
	}
	for index := range t.Changes {
		...
		if index > 0 && t.Changes[index-1].Field >= t.Changes[index].Field {
			return conflictError(errors.New("about machine changes are not canonical"))
		}
	}
	return nil
}
...
func (m CurrentMachine) Validate() error {
	...
	if m.Generation.ID != m.Observation.GenerationID || m.Generation.Fingerprint != m.Observation.Fingerprint || m.Generation.Configuration.Identity.ID != m.Observation.Configuration.Identity.ID {
		return conflictError(errors.New("about current machine generation differs from observation"))
	}
	if m.Transition == nil {
		return nil
	}
	...
	if m.Transition.CurrentGenerationID != m.Generation.ID {
		return conflictError(errors.New("about current machine transition differs from generation"))
	}
	return nil
}
