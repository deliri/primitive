...
func TestInventoryHostileBoundaryTable(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "zero files cannot claim an empty tree as observed", in: Inventory{}, wantErr: core.ErrAboutContract},
		{name: "Go packages cannot exceed files", in: Inventory{Files: 1, GoPackages: 2}, wantErr: core.ErrAboutContract},
		{name: "JavaScript units cannot exceed files", in: Inventory{Files: 1, JavaScriptUnits: 2}, wantErr: core.ErrAboutContract},
		{name: "test files cannot exceed files", in: Inventory{Files: 1, TestFiles: 2}, wantErr: core.ErrAboutContract},
		{name: "documents cannot exceed files", in: Inventory{Files: 1, Documents: 2}, wantErr: core.ErrAboutContract},
		{name: "one test file cannot claim 257 declarations", in: Inventory{Files: 1, TestFiles: 1, TestDeclarations: 257}, wantErr: core.ErrAboutConflict},
		{name: "benchmarks cannot exceed declarations", in: Inventory{Files: 1, TestFiles: 1, Benchmarks: 1}, wantErr: core.ErrAboutConflict},
		{name: "fuzz targets cannot exceed declarations", in: Inventory{Files: 1, TestFiles: 1, FuzzTargets: 1}, wantErr: core.ErrAboutConflict},
		{name: "benchmarks plus fuzz targets cannot exceed declarations", in: Inventory{Files: 1, TestFiles: 1, TestDeclarations: 1, Benchmarks: 1, FuzzTargets: 1}, wantErr: core.ErrAboutConflict},
		{name: "coverage cannot exceed one hundred percent", in: Inventory{Files: 1, CoverageBasisPoints: &coverageAbove}, wantErr: core.ErrAboutContract},
		...
		{name: "Go package count one above file count is refused", in: Inventory{Files: 8, GoPackages: 9}, wantErr: core.ErrAboutContract},
		{name: "Go package extreme above one file is refused", in: Inventory{Files: 1, GoPackages: math.MaxUint32}, wantErr: core.ErrAboutContract},
		...
		{name: "JavaScript unit count one above file count is refused", in: Inventory{Files: 8, JavaScriptUnits: 9}, wantErr: core.ErrAboutContract},
		{name: "JavaScript unit extreme above one file is refused", in: Inventory{Files: 1, JavaScriptUnits: math.MaxUint32}, wantErr: core.ErrAboutContract},
		...
		{name: "test declaration count one above per-file ceiling is refused", in: Inventory{Files: 4, TestFiles: 4, TestDeclarations: 1025}, wantErr: core.ErrAboutConflict},
		{name: "test declaration extreme with one test file is refused", in: Inventory{Files: 1, TestFiles: 1, TestDeclarations: math.MaxUint32}, wantErr: core.ErrAboutConflict},
		...
		{name: "benchmark and fuzz sum one above declarations is refused", in: Inventory{Files: 4, TestFiles: 2, TestDeclarations: 20, Benchmarks: 11, FuzzTargets: 10}, wantErr: core.ErrAboutConflict},
		{name: "benchmark and fuzz extreme sum is refused without overflow", in: Inventory{Files: math.MaxUint32, TestFiles: math.MaxUint32, TestDeclarations: math.MaxUint32, Benchmarks: math.MaxUint32, FuzzTargets: math.MaxUint32}, wantErr: core.ErrAboutConflict},
		...
		{name: "coverage one above ceiling is refused", in: Inventory{Files: 8, CoverageBasisPoints: &coverageAbove}, wantErr: core.ErrAboutContract},
