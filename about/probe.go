...
func (r ProbeRole) Validate() error {
	return validateEnum(uint8(r), probeRoleLabels(), "about probe role is invalid")
}
...
func (r ProbeRole) MarshalJSON() ([]byte, error) {
	return marshalEnum(uint8(r), probeRoleLabels(), "about probe role is invalid")
}
func (r *ProbeRole) UnmarshalJSON(data []byte) error {
	if r == nil {
		return jsonError(errors.New("nil about probe role receiver"))
	}
	value, err := unmarshalEnum(data, probeRoleLabels(), "about probe role is invalid")
	if err == nil {
		*r = ProbeRole(value)
	}
	return err
...
func (k ProbeKind) Validate() error {
	return validateEnum(uint8(k), probeKindLabels(), "about probe kind is invalid")
}
...
func (k ProbeKind) MarshalJSON() ([]byte, error) {
	return marshalEnum(uint8(k), probeKindLabels(), "about probe kind is invalid")
}
func (k *ProbeKind) UnmarshalJSON(data []byte) error {
	if k == nil {
		return jsonError(errors.New("nil about probe kind receiver"))
	}
	value, err := unmarshalEnum(data, probeKindLabels(), "about probe kind is invalid")
	if err == nil {
		*k = ProbeKind(value)
	}
	return err
...
func (k ProbeTargetKind) Validate() error {
	return validateEnum(uint8(k), probeTargetLabels(), "about probe target kind is invalid")
}
...
func (k ProbeTargetKind) MarshalJSON() ([]byte, error) {
	return marshalEnum(uint8(k), probeTargetLabels(), "about probe target kind is invalid")
}
func (k *ProbeTargetKind) UnmarshalJSON(data []byte) error {
	if k == nil {
		return jsonError(errors.New("nil about probe target receiver"))
	}
	value, err := unmarshalEnum(data, probeTargetLabels(), "about probe target kind is invalid")
	if err == nil {
...
func (t GoFileTarget) Validate() error {
	...
	return validateGoSelectionChildKinds(t.ChildKinds, "about Go file child kinds are invalid")
}
...
func (t GoPackageTarget) Validate() error {
	...
	return validateGoSelectionChildKinds(t.ChildKinds, "about Go package child kinds are invalid")
}
...
func (t ProbeTarget) Validate() error {
	...
	if t.payloadCount() != 1 {
		return contractError(errors.New("about probe target must carry exactly one variant"))
	}
...
func (t ProbeTarget) validateVariant() error {
	...
	case ProbeTargetUnknown:
		return contractError(errors.New("about probe target escaped its domain"))
	default:
		return contractError(errors.New("about probe target escaped its domain"))
	}
}
...
func validateTargetVariant[T interface{ Validate() error }](value *T) error {
	if value == nil {
		return conflictError(errors.New("about probe target variant differs from kind"))
	}
...
func (p SelectionParent) Validate() error {
	...
	if role != ProbeRoleSelection || !targetAdmitsKind(p.Target.Kind, p.Kind) {
		return conflictError(errors.New("about selection parent kind and target disagree"))
	}
	return nil
}
...
func (r RequestedProbe) Validate() error {
	...
	if r.Subject.Repository.value != r.Source.Repository.value {
		return conflictError(errors.New("about requested probe source repository differs from subject"))
	}
...
func validateRequestedKinds(target ProbeTarget, kinds []ProbeKind) error {
	if len(kinds) == 0 || len(kinds) > ProbeKindMaximum {
		return contractError(errors.New("about requested probe kinds are invalid"))
	}
	...
	if !requestedKindsMatchSelectionTarget(target, kinds) {
		return conflictError(errors.New("about requested probe kinds differ from selection child kinds"))
	}
	return nil
}
...
func validateRequestedKindAt(target ProbeTarget, kinds []ProbeKind, index int) error {
	...
	if duplicateProbeKind(kinds, index) {
		return conflictError(errors.New("about requested probe kind is duplicated"))
	}
	if index > 0 && kinds[index-1] >= kinds[index] {
		return conflictError(errors.New("about requested probe kinds are not canonical"))
	}
	if !requestedTargetAdmitsKind(target.Kind, kinds[index]) {
		return conflictError(errors.New("about requested probe kind differs from target"))
	}
	return nil
}
...
func (i ProbeIdentity) Validate() error {
	...
	if i.Subject.Repository != i.Source.Repository {
		return conflictError(errors.New("about probe identity source repository differs from subject"))
	}
...
func (i ProbeIdentity) validateRelationship() error {
	...
	if role != i.Role || !targetAdmitsKind(i.Target.Kind, i.Kind) {
		return conflictError(errors.New("about probe role, kind, and target disagree"))
	}
	if i.Role == ProbeRoleSelection && i.Parent != nil {
		return conflictError(errors.New("about selection probe cannot descend from another selection"))
	}
	if i.Parent != nil {
...
func (i ProbeIdentity) validateParent() error {
	...
	if !experimentDescendsFromSelection(i, *i.Parent) {
		return conflictError(errors.New("about experiment does not descend from its selection parent"))
	}
	return nil
}
...
func validateGoSelectionChildKinds(values []ProbeKind, diagnostic string) error {
	...
	for index := range values {
		if !goDeclarationExperiment(values[index]) {
			return conflictError(errors.New("about Go selection child kind is not a Go experiment"))
		}
		if duplicateProbeKind(values, index) || (index > 0 && values[index-1] >= values[index]) {
			return conflictError(errors.New("about Go selection child kinds are not canonical"))
		}
	}
	return nil
}
